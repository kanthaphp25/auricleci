...
// echo "<pre>"; print_r($cdata);exit;
					  ?>
							<form action="<?php echo site_url().'lesson-update';?>" method="post">
								<input type="text" style="display:none;" name="id" value="<?php echo $objdata->id;?>">
								...
								<div class="form-group">
									...
									<input type="text" placeholder="Enter content" name="content" value="<?php echo $objdata->content; ?>">
								</div><br/>
